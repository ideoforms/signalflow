...
public:
    ...
    explicit operator enable_if_t<std::is_same<T, accessor_policies::str_attr>::value || std::is_same<T, accessor_policies::obj_attr>::value, bool>() const
    {
...
template <typename T>
using is_positional = satisfies_none_of<T,
