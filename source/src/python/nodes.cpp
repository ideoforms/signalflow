...
void init_python_nodes(py::module &m)
{
    ...
    py::class_<BeatCutter, Node, NodeRefTemplate<BeatCutter>>(m, "BeatCutter")
        .def(py::init<BufferRef, int, NodeRef, NodeRef, NodeRef, NodeRef>(), "buffer"_a = nullptr, "segment_count"_a = 8, "stutter_probability"_a = 0.0, "stutter_count"_a = 1, "jump_probability"_a = 0.0, "duty_cycle"_a = 1.0);
